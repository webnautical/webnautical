    ...
    const supportContent = {
      ...
      const supportRecord = async () => {
        try {
          ...
          const response = await fetch(`${config.url}/v1/get_refund_policy_details`, {
            method: 'GET',
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <section className='text-center glabal_text_page  text-size mt-5'>
            <Container>
                <Row>
...
const RefundPolicyCart = ({cartData}) =>{
